...
""" Vundle plugin manager {{{
    ...
    " Extra fancy web dev hi-speed coding
...
""" User interface {{{
    """ Syntax highlighting {{{
        ...
        let g:seoul256_background = 235             " darkness of seoul256 colo
...
""" Plugin settings {{{
    ...
    let g:startify_custom_header = [ 
        ...
        \ '              "8888888888888888888888888   b                楊文里 (@defm03)',
        \ '                 ""888888888888888888888  c                defm03@outlook.jp',
        \ '                     "8888888888888888888  P           2014, Chinese Hacking',
